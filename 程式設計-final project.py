        ...
        if action == "1":
            ...
            if room["npcs"]:
                ...
                for npc_name in room["npcs"]:
                    print(f" - {npc_name}")
                npc_choice = input("Which NPC do you want to talk to? (Enter NPC name or 'exit' to leave): ")
                if npc_choice in room["npcs"]:
                    print(f"You talk to {npc_choice}.")
                    talk_to_npc(npc_choice)
                else:
